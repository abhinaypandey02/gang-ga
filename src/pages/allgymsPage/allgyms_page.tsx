      ...
      <div className="container-fluid">
        <div className="row d-flex justify-content-center">
          <div className="col-md-3 p-3 m-lg-3 text-start" id="filterbox">
            <SimpleSelect2 sortBy={category} setSortBy={setCategory} />
          </div>
          <div className="col-md-3 p-3 m-lg-3 text-start" id="filterbox">
                      ...
                      <div className="col-md-8 py-2">
                        <div className="card-body text-start">
                          ...
                          <h6 className="text-dark">
                            ...
                            />
                            {gym.location.locality}, {gym.location.area},{" "}
                            {gym.location.district}, {gym.location.state}
                          </h6>
                          <h6 className="text-dark">
                            {latitude && longitude && gym.distance.toFixed()}
                            km
                          </h6>
